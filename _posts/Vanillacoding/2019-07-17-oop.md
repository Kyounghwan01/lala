---
layout: post
title: "[JavaScript][Vanillacoding] oop"
date: 2019-07-17
excerpt: "oop"
tag:
- JavaScript
...
객체를 통해 물건을 만들고 갸는 기능을 가진데 

상황에 따라, 쓸모있는 용도인가에 따라 객체 선언 방법 다르게 활용합니다.
...
복잡한 원리, 구동방식을 사용자로부터 추상화작업도 중요하다.
...
그 다음으로
램프가 몇개 더 필요합니다. 앞으로도 계속 램프가 필요합니다.
...
- factory를 통해 
- 함수가 객체를 리턴하게 만들어, 그 함수를 보통 factory함수라 말한다.
- 객체를 만드는데 생성자 함수가 아니다,. 그러면 factory 함수 
...
수소차도 soldTo함수를 가져야 합니다. 그렇기에 기존의 Car의 함수를 위임받도록 합시다
